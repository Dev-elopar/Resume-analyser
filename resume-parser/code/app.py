...
def run():
    ...
    img = Image.open(r'C:\Users\kerub\resume-parser\Logo\SRA_Logo.jpg')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            #     time.sleep(4)
            save_image_path = r'C:\Users\kerub\resume-parser\code'+pdf_file.name
            ...
            if resume_data:
                ...
                st.success('** Your Resume Writing Skills Score: ' + str(score)+'**')
                st.warning("** Note: This score is calculated based on the important fields answered in your resume **")
                st.balloons()
   #Insert the data into the database
        ...
        ## Admin Side
        st.success('Welcome to Hiring Manager')
        # st.sidebar.subheader('**ID / Password Required!**')

        ad_user = st.text_input("Username")
        ad_password = st.text_input("Password", type='password')
        if st.button('Login'):
            if ad_user == 'Annamaria' and ad_password == '12345678':
                st.success("Welcome Annamaria")
                # Display Data
                ...
                ## displaying Pie chart for predicted field recommendations
                ...
                ### Display Pie chart for User's👨‍💻 Experienced Level
